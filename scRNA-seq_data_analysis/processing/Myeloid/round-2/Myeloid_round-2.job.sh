...
echo -e "Project name: R24_Cancer_Batches-1-to-20_Myeloid_Normal-lung_Subset-A"
echo -e "Job output directory: /mnt/hpcscratch/vfajardo/R24/jobs_scripts/seurat_analysis//R24_Cancer_Myeloid/R24_Cancer_Batches-1-to-20_Myeloid_Normal-lung_Subset-A/R24_Cancer_Batches-1-to-20_Myeloid_Normal-lung_Subset-A_11-08-2022qc-std_var-30_pc-30_hto-all_harmony-seq.batch.tag_regresscc-NULL"
