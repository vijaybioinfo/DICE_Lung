...
echo -e "Project name: R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_NK-cells-2"
echo -e "Job output directory: /mnt/hpcscratch/vfajardo/R24/jobs_scripts/seurat_analysis//R24_Cancer_NKAndB/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_NK-cells-2/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_NK-cells-2_11-08-2022qc-nk-spc_var-25_pc-20_hto-all_harmony-seq.batch.tag_regresscc-NULL"
...
echo -e "PCs to be taken into account for dimensionality reduction: 'c(20)'\n\n"
