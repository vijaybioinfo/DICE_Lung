#PBS -N Seurat_Analysis_R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2
#PBS -o /mnt/hpcscratch/vfajardo/R24/jobs_scripts/seurat_analysis//R24_Cancer_NKAndB/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2_11-08-2022qc-b-spc_var-25_pc-30_hto-all_harmony-seq.batch.tag_regresscc-NULL/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2_general_seurat_analysis.out.txt
...
echo -e "Project name: R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2"
echo -e "Job output directory: /mnt/hpcscratch/vfajardo/R24/jobs_scripts/seurat_analysis//R24_Cancer_NKAndB/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2/R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2_11-08-2022qc-b-spc_var-25_pc-30_hto-all_harmony-seq.batch.tag_regresscc-NULL"
echo -e "### ------------------- Seurat analysis arguments ------------------- ###"
echo -e "Seurat script version (absolute path): /home/vfajardo/scripts/seurat_analysis/general_seurat_analysis.2.3.4.R"
echo -e "Project name: R24_Cancer_Batches-1-to-20_NKAndB_Normal-lung_B-cells-2"
